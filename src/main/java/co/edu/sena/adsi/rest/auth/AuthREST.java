...
public class AuthREST {
    ...
    public Response login(Users users, @Context final HttpServletRequest request) throws JOSEException {
        final Users foundUser;
        GsonBuilder builder = new GsonBuilder();
        Gson gson = builder.create();
        foundUser = usersEJB.findUsersByNumDocument(users.getNumDocument());
        ...
        } else if (users.getPassword().equals(foundUser.getPassword())) {
